...
def convolutional_GenDiscr():
    ...
    def get_discriminator():
        ...
        conv1 = keras.layers.Conv2D(32, kernel_size=3, padding="same")(inputs)
        ...
        conv3 = keras.layers.Conv2D(128, kernel_size=3, padding="same")(act2)
        mp3 = keras.layers.MaxPool2D()(conv3)
        act3 = keras.layers.Activation(activation="tanh")(mp3)
        conv4 = keras.layers.Conv2D(256, kernel_size=3, padding="same")(act3)
