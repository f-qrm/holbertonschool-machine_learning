...
class WGAN_GP(keras.Model):
    ...
    def replace_weights(self, gen_h5, disc_h5):
        """Load pre-trained weights into the generator and discriminator.

        Args:
            gen_h5: path to the .h5 file containing the generator's
                weights.
            disc_h5: path to the .h5 file containing the
                discriminator's weights.
        """
        # Charge les poids sauvegardés dans le générateur.
        self.generator.load_weights(gen_h5)
        # Charge les poids sauvegardés dans le discriminateur.
